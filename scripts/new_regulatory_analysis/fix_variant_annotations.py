#!/usr/bin/env python3
# /Users/zakiralibhai/Documents/GitHub/Yeast_MSA/scripts/new_regulatory_analysis/fix_variant_annotations.py
...
def main():
    ...
    # Define file paths
    scaffold_variants_file = '/Users/zakiralibhai/Documents/GitHub/Yeast_MSA/results/filtered_scaffold_variants/treatment_specific_scaffold_variants.tsv'
    ...
    old_annotations_file = '/Users/zakiralibhai/Documents/GitHub/Yeast_MSA/results/new_regulatory_analysis/data/variant_regulatory_annotations.tsv'
    output_file = '/Users/zakiralibhai/Documents/GitHub/Yeast_MSA/results/new_regulatory_analysis/data/fixed_variant_regulatory_annotations.tsv'
    output_dir = '/Users/zakiralibhai/Documents/GitHub/Yeast_MSA/results/new_regulatory_analysis/data'
    ...
    for i, row in scaffold_variants.iterrows():
        ...
        if key in annotation_lookup:
            ...
            if 'Distance' in row and 'Position_Relative' in row:
                distance = row['Distance']
                position_relative = row['Position_Relative']
