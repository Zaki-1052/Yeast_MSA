    ...
    if gene_mapping_file:
        try:
            ...
            for _, row in gene_df.iterrows():
                ...
                # Add to genes of interest if it has an erg_name
...
def map_variants_to_genes(variant_df):
    ...
    for idx, row in result_df.iterrows():
        ...
        # Try to match using both chromosome ID and scaffold
        # First, try direct match on chromosome or scaffold
        ...
        # 1. Check if this could be a chromosome ID when scaffold is expected
        # 2. Check if this could be a scaffold when chromosome ID is expected
        # 3. Check if there's a mapping between them
        
        # Track chromosome misses for diagnostics
